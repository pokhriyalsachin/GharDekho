...
export default function ListingItem({ listing }) {
  return (
    <div className='bg-white shadow-md hover:shadow-lg tarnsition-shadow overflow-hidden rounded-lg w-full sm:w-[330px]'> 
        ...
        <div className='p-3 flex flex-col gap-2 w-full'>
          ...
          {/*line-clamp-2 turncate text after specified line  */}
